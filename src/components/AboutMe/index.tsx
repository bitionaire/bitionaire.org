...
const AboutMe: React.SFC = () => (
  <section className="about-me">
    <div className="about-me__text">
      <p>
        <strong>Work in progress.</strong> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
    ...
    <section className="about-me__aside">
      <h1>About me</h1>
      <div className="about-me__heading-underline" />
    </section>
  </section>
);
